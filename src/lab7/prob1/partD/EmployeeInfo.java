...
public class EmployeeInfo {
  ...
  /**
   * Removes all duplicate Employee instances from input list (only a copy is modified) An Employee
   * instance is considered to be a duplicate of another Employee instance if the two instances have
  ...
  /**
   * Returns true if the two lists have the same size and contain exactly the same elements (this is
   * really just set equality)
   */
