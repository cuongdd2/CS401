package lesson7.hashcode.bad2;

import java.util.GregorianCalendar;
import java.util.HashMap;

/**
 * Shows what goes wrong when you use a user-defined class as a key in a hashtable when you override
 * equals but do not override hashcode
 *
 * @author pcorazza
 */
public class Main {
